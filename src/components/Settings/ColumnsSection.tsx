                    ...
                    <>
                      ...
                      <td>
                        <div className="table-actions">
                          <button className="btn btn-icon btn-ghost btn-sm" title="Edit" onClick={() => startEdit(col.id)}>
                          ...
                          <button className="btn btn-icon btn-ghost btn-sm" title="Delete" style={{ color: 'var(--color-danger)' }} onClick={() => deleteColumn(col.id)}>
